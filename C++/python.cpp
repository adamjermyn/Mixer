...
extern "C" double* coeffs3sphericalSpecific(int output[correlDim*correlDim], double theta, double tolr, double tola, double B, double tB, double pB, double omega, double w, double tW, double tS, double tP, double N2, int maxEval) {
...
extern "C" double* coeffs2sphericalSpecific(int output[correlDim*correlDim], double theta, double tolr, double tola, double omega, double w, double tW, double tS, double tP, double N2, int maxEval) {
...
extern "C" double* coeffs2sphericalSpecificBox(double mins[2], double maxs[2], int output[correlDim*correlDim], double theta, double tolr, double tola, double omega, double w, double tW, double tS, double tP, double N2, int maxEval) {
...
extern "C" double* coeffs3sphericalSpecificBox(double mins[3], double maxs[3], int output[correlDim*correlDim], double theta, double tolr, double tola, double B, double tB, double pB, double omega, double w, double tW, double tS, double tP, double N2, int maxEval) {
...
extern "C" double* correlator(double k, double kT, double kP, double B, double tB, double pB, double omega, double w, double tW, double tS, double tP, double N2) {
	flmatrix f(B,tB,pB,w,tW,tS,tP,N2,omega);
	f.set_k(k, kT, kP);
